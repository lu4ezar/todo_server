...
const resolvers: Resolvers = {
  Query: {
    ...
    checklists: (_, __, { dataSources }): Checklist[] => dataSources.checklistsAPI.getChecklists(),
  } as QueryResolvers,
  Mutation: {
    createChecklist: async (_, { input }, { dataSources }): Promise<Checklist> =>
      dataSources.checklistsAPI.createChecklist(input),
    updateChecklist: async (_, { id, input }, { dataSources }): Promise<Checklist> =>
