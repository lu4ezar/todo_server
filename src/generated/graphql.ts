...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  reorderTodos?: Resolver<ResolversTypes['Todo'], ParentType, ContextType, RequireFields<MutationReorderTodosArgs, 'id' | 'order'>>;
  createChecklist?: Resolver<ResolversTypes['Checklist'], ParentType, ContextType, RequireFields<MutationCreateChecklistArgs, 'input'>>;
  updateChecklist?: Resolver<ResolversTypes['Checklist'], ParentType, ContextType, RequireFields<MutationUpdateChecklistArgs, 'input'>>;
  deleteChecklist?: Resolver<ResolversTypes['Checklist'], ParentType, ContextType, RequireFields<MutationDeleteChecklistArgs, 'id'>>;
  reorderChecklists?: Resolver<ResolversTypes['Checklist'], ParentType, ContextType, RequireFields<MutationReorderChecklistsArgs, 'id' | 'order'>>;
